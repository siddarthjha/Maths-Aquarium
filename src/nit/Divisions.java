...
public class Divisions extends JFrame implements ActionListener 
{
	static JLabel l1,l2,l3,l4,result,sign, msg;
	JButton next,home;
	...
	public Divisions(int n)
	{
		...
		l1 = new JLabel();
		l2 = new JLabel(new ImageIcon(this.getClass().getResource("/devide.png")));
		l3 = new JLabel();
		...
		msg = new JLabel("Quotient ?");
		msg.setBounds(width/2-170,30,350,70);
		msg.setFont(new Font("Times New Roman",Font.BOLD,70));
