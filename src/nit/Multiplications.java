...
public class Multiplications extends JFrame implements ActionListener 
{
	...
	public Multiplications(int n)
	{
		...
		l1 = new JLabel();
		l2 = new JLabel(new ImageIcon(this.getClass().getResource("/multiply.png")));
		l3 = new JLabel();
