...
public class Substractions extends JFrame implements ActionListener 
{
	...
	public Substractions(int n)
	{
		...
		l1 = new JLabel();
		l2 = new JLabel(new ImageIcon(this.getClass().getResource("/minus.png")));
		l3 = new JLabel();
